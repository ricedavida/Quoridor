...
public class AI_Methods {
	...
	static String list,fastestPathLeft,fastestPathRight;
	static String failedPaths[] = new String[100];
	...
	/*public String currentPositionOfPawn(String pawn){
		for(int i=0; i<81; i++)
	...
	public static String fastestPathLeft(String pos){
		return fastestPathLeft;
	}
	
	public static String fastestPathRight(String a[][]){
